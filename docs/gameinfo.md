...
<tr>
  <td> <img src="{{ 'assets/img/BlockerWithGravityColored.png' | relative_url }}"  alt="BlockerWithGravityColored" width = 75px height = 75px></td>
...
<tr>
  <td> <img src="{{ 'assets/img/BlockerWithGravity2hp.png' | relative_url }}"  alt="grass" width = 75px height = 75px></td>
...
<tr>
  <td> <img src="{{ 'assets/img/butterfly.png' | relative_url }}"  alt="MegaMultiColoredBlocker" width = 75px height = 75px></td>
...
<tr>
  <td> <img src="{{ 'assets/img/sunflower3.png' | relative_url }}"  alt="MegaMultiColoredBlocker" width = 75px height = 75px></td>
